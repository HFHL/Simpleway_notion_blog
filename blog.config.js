...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Simple_Way', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我们是一群追逐AI浪潮的梦想家和实干家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://simpleway.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, LLM', // 网站关键词 英文逗号隔开
